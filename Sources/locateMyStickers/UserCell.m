...
- (void)notifyDelegate {
    ...
    if (state != MCSwipeTableViewCellStateNone) {
        if (_delegate != nil && [_delegate respondsToSelector:@selector(swipeUserTableViewCell:didTriggerState:withMode:)]) {
            [_delegate swipeUserTableViewCell:self didTriggerState:state withMode:_mode];
        }
    }
}
