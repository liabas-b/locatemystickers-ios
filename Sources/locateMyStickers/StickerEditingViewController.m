...
- (void)bindView {
	if (self.stickerConfigurationRecord != nil) {
		self.updateFrequencySlider.value = [self.stickerConfigurationRecord.frequencyUpdate intValue];
		self.isActivatedSwitch.on = [self.stickerConfigurationRecord.activate boolValue];
...
- (void)unBindView {
	if (self.stickerConfigurationRecord != nil) {
		self.stickerConfigurationRecord.frequencyUpdate = @(self.updateFrequencySlider.value);
		self.stickerConfigurationRecord.activate = @(self.isActivatedSwitch.on);
	}
}
