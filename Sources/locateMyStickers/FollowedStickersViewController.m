...
@property (nonatomic, strong)StickerRecord *currentSticker;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	StickerRecord *stickerRecord = [self.followedStickersList objectAtIndex:indexPath.row];
	self.currentSticker = stickerRecord;
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
	...
	if ([segue.identifier isEqualToString:@"StickerDetailSegue"]) {
		...
		[stickerDetailViewController setStickerRecord:self.currentSticker];
	}
}
